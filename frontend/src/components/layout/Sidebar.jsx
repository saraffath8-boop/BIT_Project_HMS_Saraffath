...
const navItems = [
    ...
    },
    {
        ...
        to: '/radiology',
        icon: ScanLine,
        roles: ['admin', 'doctor', 'nurse', 'radiologist'],
    },
    {
        label: 'Billing',
        to: '/billing',
        icon: CreditCard,
        roles: ['admin', 'receptionist', 'pharmacist', 'lab_technician', 'radiologist'],
    },
...
export default function Sidebar({ open, onClose, role, unreadCount = 0 }) {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    'fixed inset-y-0 left-0 z-50 flex w-72 -translate-x-full flex-col border-r border-slate-200 bg-white transition-transform lg:translate-x-0',
                    open && 'translate-x-0',
                )}
            >
                <div className="flex h-20 items-center gap-3 border-b border-slate-100 px-6">
                    ...
                    >
                        <div className="grid size-10 place-items-center rounded-xl bg-cyan-700 text-white">
                    ...
                    <button className="ml-auto text-slate-500 lg:hidden" onClick={onClose}>
                        <X className="size-5" />
                    </button>
                </div>
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    cn(
                                        ...
                                        isActive && 'bg-cyan-50 text-cyan-800',
                                    )
                                }
                            >
                                ...
                                {label === 'Notifications' && unreadCount > 0 && (
                                    <span
                                        className="grid min-w-5 place-items-center rounded-full bg-red-600 px-1.5 py-0.5 text-xs font-bold text-white"
