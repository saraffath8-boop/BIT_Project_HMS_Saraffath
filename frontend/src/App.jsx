    ...
    return (
        <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
            <Routes>
                ...
                <Route path="/appointments/new" element={roleRoute(['receptionist'], <AppointmentCreatePage />)} />
                ...
                <Route path="/billing" element={roleRoute(['admin', 'receptionist', 'pharmacist', 'lab_technician', 'radiologist'], <BillingPage />)} />
                <Route path="/billing/new" element={roleRoute(['admin'], <BillCreatePage />)} />
                <Route path="/billing/patient-decisions" element={roleRoute(['admin', 'pharmacist', 'lab_technician', 'radiologist'], <PatientDecisionBillingPage />)} />
