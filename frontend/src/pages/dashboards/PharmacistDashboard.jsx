...
const cards = [
    ...
    { title: 'Billing', description: 'Collect prescription payments and review pharmacy bills.', to: '/billing' },
    { title: 'Patient Decisions', description: 'Process patient decisions for prescriptions.', to: '/billing/patient-decisions' },
