        ...
        <main className="space-y-7">
            <section className="overflow-hidden rounded-2xl border border-cyan-100 bg-white p-6 shadow-sm sm:p-8">
                <div className="flex items-start gap-4">
                    <div className="hidden size-12 place-items-center rounded-xl bg-cyan-50 text-cyan-700 sm:grid">
            ...
            <section>
                <div className="mb-4">
                    <h2 className="text-lg font-semibold text-slate-900">Clinical workspace</h2>
                    <p className="text-sm text-slate-500">
                        Open the modules available for your role.
                    </p>
                </div>
                    ...
                    {cards.map((card) => {
                        ...
                        return card.to ? (
                            <Link key={card.title} to={card.to} className="group">
                                <Card className="h-full transition hover:-translate-y-0.5 hover:border-cyan-200 hover:shadow-md">
                                    <CardHeader>
                            ...
                            <Card key={card.title} className="opacity-60">
                                <CardContent className="p-6">{card.title}</CardContent>
                            </Card>
                        );
                    })}
                </div>
