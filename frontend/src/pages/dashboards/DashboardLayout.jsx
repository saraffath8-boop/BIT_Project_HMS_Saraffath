import { ArrowUpRight, Bell, CalendarDays, ClipboardList, CreditCard, FlaskConical, FolderHeart, Pill, ScanLine, Stethoscope, Users } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../../components/ui/card';

const icons = { Appointments: CalendarDays, Patients: Users, 'Medical Records': FolderHeart, Prescriptions: Pill, Billing: CreditCard, 'Patient Decisions': CreditCard, Laboratory: FlaskConical, 'Laboratory Requests': FlaskConical, Radiology: ScanLine, 'Radiology Requests': ScanLine, Notifications: Bell, Queue: ClipboardList };
