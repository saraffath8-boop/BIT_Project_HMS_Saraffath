...
const linkedCards = [
    ...
    {
        title: 'Notifications',
        description: 'View hospital notifications assigned to your account.',
        to: '/notifications',
    },
    {
        title: 'Appointments',
        description: 'View appointments linked to your patient profile.',
        to: '/my/appointments',
    },
    {
        title: 'Prescriptions',
        description: 'View prescriptions linked to your patient profile.',
        to: '/my/prescriptions',
    },
    {
        title: 'Reports',
        description: 'View lab and radiology reports linked to your patient profile.',
        to: '/my/reports',
    },
