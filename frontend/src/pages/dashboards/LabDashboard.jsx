...
const cards = [
    ...
    { title: 'Billing', description: 'Collect laboratory payments and review paid laboratory bills.', to: '/billing' },
    { title: 'Patient Decisions', description: 'Process patient decisions for laboratory requests.', to: '/billing/patient-decisions' },
