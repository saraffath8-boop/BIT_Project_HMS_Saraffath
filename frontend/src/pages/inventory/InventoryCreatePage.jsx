...
const InventoryCreatePage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await createInventoryItem(
                {
                    ...
                    supplier: getOptionalValue(formData.supplier),
            ...
            setError(err.message || 'Unable to create inventory item');
        } finally {
            setSubmitting(false);
        }
    };
    return (
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    <p style={styles.kicker}>Inventory Management</p>
                    <h1 style={styles.title}>Create Inventory Item</h1>
                    <p style={styles.subtitle}>
                        Add a hospital supply or equipment item with stock and location details.
                    </p>
                </div>
                <div style={styles.actions}>
                    <Link style={styles.secondaryLink} to="/inventory">
                        Inventory
                    </Link>
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
                ...
                <button style={styles.primaryButton} type="submit" disabled={submitting}>
                    {submitting ? 'Creating Inventory Item...' : 'Create Inventory Item'}
                </button>
            </form>
        </main>
    );
