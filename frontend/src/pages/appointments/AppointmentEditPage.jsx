    ...
    if (loading)
        return (
            <main style={styles.page}>
                <div style={styles.notice}>Loading appointment.</div>
            </main>
        );
        ...
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <h1 style={styles.title}>Update Appointment</h1>
                    <p style={styles.subtitle}>Reschedule, update, or cancel this appointment.</p>
                </div>
