    ...
    if (loading)
        return (
            <main style={styles.page}>
                <div style={styles.notice}>Loading queue entry.</div>
            </main>
        );
        ...
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <h1 style={styles.title}>Update Queue Entry</h1>
                    <p style={styles.subtitle}>Manage department, priority, and service status.</p>
                </div>
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
                ...
                <button style={styles.primaryButton} type="submit" disabled={submitting}>
                    {submitting ? 'Saving...' : 'Save Queue Entry'}
                </button>
            </form>
        </main>
    );
