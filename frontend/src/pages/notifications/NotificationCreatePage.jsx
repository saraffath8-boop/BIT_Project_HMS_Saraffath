// This file contains the notification create page interface.
...
const getUserLabel = (user) =>
    `${user.name || 'Unnamed User'}${user.email ? ` (${user.email})` : ''} - ${user.role}`;

// Show the notification create page interface.
            ...
            await createNotification(
                {
                    ...
                    type: formData.type,
                    relatedPatient: getOptionalValue(formData.relatedPatient),
                },
                token,
            );
        ...
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <h1 style={styles.title}>Create Notification</h1>
                    <p style={styles.subtitle}>Send a notification to an existing user account.</p>
                </div>
                <div style={styles.actions}>
                    <Link style={styles.secondaryLink} to="/notifications">
                        Notifications
                    </Link>
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
                <div style={styles.grid}>
                    ...
                    <label style={styles.label}>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                        >
                            <option value="">No related patient</option>
                ...
                <button style={styles.primaryButton} type="submit" disabled={submitting}>
                    {submitting ? 'Creating Notification...' : 'Create Notification'}
                </button>
            </form>
        </main>
    );
