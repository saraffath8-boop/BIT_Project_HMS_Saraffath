    ...
    return (
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>
                        Submit feedback, review complaint status, and track administrative
                        responses.
                    </p>
                </div>
            ...
            {!loading && !error && feedbackEntries.length === 0 && (
                <div style={styles.notice}>No feedback entries are currently available.</div>
            )}
                ...
                <div style={styles.list}>
                    {feedbackEntries.map((entry) => (
                        <article key={entry.id} style={styles.card}>
                            ...
                            {entry.response && (
                                <p style={styles.response}>Response: {entry.response}</p>
                            )}
                        </article>
                    ))}
                </div>
