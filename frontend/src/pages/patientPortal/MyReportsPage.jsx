...
const MyReportsPage = () => {
    ...
    const hasReports =
        labRequests.length > 0 || radiologyRequests.length > 0 || medicalRecords.length > 0;
        ...
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>
                        View lab and radiology records linked to your patient profile.
                    </p>
                </div>
            ...
            {!loading && !error && !hasReports && (
                <div style={styles.notice}>
                    No lab or radiology reports are currently available for your profile.
                </div>
            )}
                ...
                <>
                    <section style={styles.section}>
                        ...
                        {medicalRecords.length === 0 ? (
                            <p style={styles.emptyText}>No diagnosis reports available.</p>
                        ) : (
                                            ...
                                            <tr key={record.id}>
                                                ...
                                                <td style={styles.td}>
                                                    <button
                                                        ...
                                                        type="button"
                                                        onClick={() =>
                                                            downloadMedicalRecordPdf(record)
                                                        }
                                                    >
                                                        Download PDF
                                                    </button>
                                    ...
                                    <tbody>
                                        {labRequests.map((request) => (
                                            <tr key={request.id}>
                                                ...
                                                <td style={styles.td}>
                                                    {formatPerson(request.doctor)}
                                                </td>
                                                <td style={styles.td}>
                                                    {formatTestNames(request.tests)}
                                                </td>
                                                <td style={styles.td}>
