        ...
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>
                        View prescriptions linked to your patient profile.
                    </p>
                </div>
            ...
            {!loading && !error && prescriptions.length === 0 && (
                <div style={styles.notice}>
                    No prescriptions are currently available for your profile.
                </div>
            )}

            {!loading && !error && prescriptions.length > 0 && (
                <CollapsibleSection title="My Prescriptions" count={prescriptions.length}>
                            ...
                            <article key={prescription.id} style={styles.card}>
                                ...
                                <div style={styles.detailGrid}>
                                    <div>
                                        ...
                                        <strong style={styles.value}>
                                            {formatDoctor(prescription.doctor)}
                                        </strong>
                                    </div>
                                    <div>
                                ...
                                <div style={styles.medicineBlock}>
                                    ...
                                    <div style={styles.medicineList}>
                                        {(prescription.items || []).map((item) => (
                                            <div
                                                key={`${prescription.id}-${formatMedicineName(item)}-${item.dosage}-${item.frequency}`}
                                                style={styles.medicineItem}
                                            >
                                                <strong style={styles.medicineName}>
                                                    {formatMedicineName(item)}
                                                </strong>
                                                <span style={styles.medicineMeta}>
                                        ...
                                        {(prescription.items || []).length === 0 && (
                                            <p style={styles.notes}>No medicines listed.</p>
                                        )}
                                    </div>
                                </div>
                            </article>
