            ...
            await createBill(
                {
                    ...
                    discount: getNumberValue(formData.discount),
    ...
    return (
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    <p style={styles.kicker}>Billing Management</p>
                    <h1 style={styles.title}>Create Bill</h1>
                    <p style={styles.subtitle}>
                        Create a patient bill with service items and discount details.
                    </p>
                </div>
                <div style={styles.actions}>
                    <Link style={styles.secondaryLink} to="/billing">
                        Billing
                    </Link>
