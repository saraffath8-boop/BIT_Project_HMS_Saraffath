    ...
    return (
        <main style={styles.page}>
            <section style={styles.header}>
                <div>
                    <p style={styles.kicker}>Pharmacy Management</p>
                    <h1 style={styles.title}>Create Medicine</h1>
                    <p style={styles.subtitle}>
                        Add a medicine record with SKU, pricing, stock, and reorder details.
                    </p>
                </div>
                <div style={styles.actions}>
                    <Link style={styles.secondaryLink} to="/pharmacy">
                        Pharmacy
                    </Link>
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
                ...
                <button style={styles.primaryButton} type="submit" disabled={submitting}>
                    {submitting ? 'Creating Medicine...' : 'Create Medicine'}
                </button>
            </form>
        </main>
    );
