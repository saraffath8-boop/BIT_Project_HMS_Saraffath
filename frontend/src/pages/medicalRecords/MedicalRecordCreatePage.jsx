// This file contains the medical record create page interface.
...
// Show the medical record create page interface.
const MedicalRecordCreatePage = () => {
    ...
    const loadPatients = useCallback(async () => {
        ...
        try {
            ...
            if (user?.role === 'admin')
                requests.push(getUsers({ token, filters: { role: 'doctor' } }));
            ...
            <section style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>
                        Record consultation details, diagnosis, vital signs, and follow-up
                        information.
                    </p>
                </div>
                <div style={styles.actions}>
                    <Link style={styles.secondaryLink} to="/medical-records">
                        Medical Records
                    </Link>
