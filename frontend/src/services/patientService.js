...
export const getMyPatientProfile = async (token) => {
    try {
        ...
        throw new Error(getErrorMessage(error, 'Unable to load your patient profile'), {
            cause: error,
        });
    }
};
...
export const linkPatientUser = async (id, userId, token) => {
    try {
        ...
        throw new Error(getErrorMessage(error, 'Unable to link patient user account'), {
            cause: error,
        });
    }
};
